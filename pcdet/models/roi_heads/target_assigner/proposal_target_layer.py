# -*- coding: utf-8 -*-
"""
Created on Sat May 21 09:39:43 2022
...
class ProposalTargetLayer(nn.Module):
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        batch_roi_features = roi_features.new_zeros(batch_size, self.roi_sampler_cfg.ROI_PER_IMAGE, roi_features.shape[-1])

        for index in range(batch_size):
            cur_roi, cur_gt, cur_roi_labels, cur_roi_scores, cur_roi_features = \
                rois[index], gt_boxes[index], roi_labels[index], roi_scores[index], roi_features[index]
            k = cur_gt.__len__() - 1
